...
'INGENIEROS
'ING. JESÚS VELÁZQUEZ ESPINOZA
'ING. LEONARDO DANIEL PRIETO PRIETO
'ING. LEONARDO RODRÍGUEZ ÁLVAREZ
'ING. EDUARDO VILLALOBOS AGUILAR
'ING. EDSON EDUARDO LÓPEZ REYES
'ING. MIGUEL ÁNGEL APARICIO HERNÁNDEZ
'ING. ALAN JOEL CASTILLO GONZÁLEZ
'ING.WILLIAMS RIVERA HERNANDEZ
'ING. JUAN CARLOS ARELLANO BACA

'REVISÓ
'ING. LAURA ITZEL MARTÍNEZ SUÁREZ
'T.L.Q. JOSÉ DHASSAEV MONTOYA JUÁREZ
...
'DL MÉDICA, GIP, DENTILAB, DLP, PHARMA
If RAZ_SOC <> "PRO" Then

    If RAZ_SOC = "DLM" Then
    REVISA = "T.L.Q. JOSÉ DHASSAEV MONTOYA JUÁREZ"
    
    ElseIf RAZ_SOC <> "DLM" Then
    REVISA = "ING. LAURA ITZEL MARTÍNEZ SUÁREZ"
    End If
...
Sheets(P_3).Range("D4").value = "Febrero de 1917 s/n Zona Industrial de Chalco, " & _
                                "Chalco Edo. de México CP 56600, Tel. 597 56060"
